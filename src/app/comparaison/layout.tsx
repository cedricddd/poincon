...
export const metadata: Metadata = {
  ...
  description: 'Comparez Pointon avec les autres solutions de pointage en Belgique. Seul Pointon est 100% conforme loi 2027, mobile-first et gratuit pour démarrer.',
