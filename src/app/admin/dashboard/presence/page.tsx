                ...
                <div className="divide-y divide-[var(--pp-line)]">
                  {group.people.map(p => (
                    <div key={p.id} className="flex items-center justify-between py-3">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-[var(--pp-info)]/10 flex items-center justify-center text-xs font-bold text-[var(--pp-info)]">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-sm font-semibold text-[var(--pp-pos)]">{fmt(p.arrivalTime)}</p>
                      </div>
                    </div>
                  ))}
                </div>
